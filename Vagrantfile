...
#--------------NODE1-------------
  config.vm.define "rac1n1" do |node|  # node1
    ...
    config.vm.provider "virtualbox" do |vb|  # node1 customize
      ...
      # Disk 1
      file_name='C:\VMDisks\cbora12crac1\asm1.vmdk'
      file_type='vmdk'
      port_number=1
      ...
      # Disk 2
      file_name='C:\VMDisks\cbora12crac1\asm2.vmdk'
      file_type='vmdk'
      port_number=2
      if !File.exist?(file_name)
        puts ("creating file2")
      ...
      # Disk 3
      file_name='C:\VMDisks\cbora12crac1\asm3.vmdk'
      file_type='vmdk'
      port_number=3
      if !File.exist?(file_name)
        puts ("creating file3")
      ...
      # Disk 4
      file_name='C:\VMDisks\cbora12crac1\asm4.vmdk'
      file_type='vmdk'
      port_number=4
      if !File.exist?(file_name)
        puts ("creating file4")
      ...
      # Disk 5
      file_name='C:\VMDisks\cbora12crac1\asm5.vmdk'
      file_type='vmdk'
      port_number=5
      if !File.exist?(file_name)
        puts ("creating file5")
      ...
      # Disk 6
      file_name='C:\VMDisks\cbora12crac1\asm6.vmdk'
      file_type='vmdk'
      port_number=6
      if !File.exist?(file_name)
        puts ("creating file6")
    ...
    node.vm.provision :chef_solo do |chef|
      ...
      #'recipe[cbora12crac1::users_and_groups]'
